                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <select class="form-control form-control-md" id="manageOrderStatus"
                                                            ...
                                                            <option value="waiting"
                                                                {{ old('type', request()->input('type')) == 'waiting' ? 'selected' : '' }}>
                                                                waiting</option>
                                                            <option value="progress"
                                                                {{ old('type', request()->input('type')) == 'progress' ? 'selected' : '' }}>
                                                                progress</option>
                                                            <option value="completed"
                                                                {{ old('type', request()->input('type')) == 'completed' ? 'selected' : '' }}>
                                                                completed</option>
                                                        </select>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card-content">
                                            <div class="card-body">
                                                <div class="col-lg-12 col-xl-12">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label
                                                                        ...
                                                                        Count:</label>
                                                                    <p class="mt-1 font-italic">
                                                                        {{ $order->serviceImages->where('type', 'main')->where('order_service_id', $orderDetail->service->id)->count() +$order->serviceImages->where('type', 'referance')->where('order_service_id', $orderDetail->service->id)->count() }}
                                                                    </p>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label
                                                                        ...
                                                                        Photos:</label>
                                                                    <p class="mt-1 font-italic">
                                                                        {{ $order->serviceImages->where('type', 'main')->where('order_service_id', $orderDetail->service->id)->count() }}
                                                                    </p>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    <label
                                                                        ...
                                                                        Photos:</label>
                                                                    <p class="mt-1 font-italic">
                                                                        {{ $order->serviceImages->where('type', 'referance')->where('order_service_id', $orderDetail->service->id)->count() }}
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group text-center">
                                                                        <label
                                                                            ...
                                                                            Time:</label>
                                                                        <p class="mt-1 font-italic">
                                                                            {{ $order->orderServiceNotes->where('order_service_id', $orderDetail->service->id)->first()?->orderServiceTime?->name }}
                                                                            -
                                                                            ${{ $order->orderServiceNotes->where('order_service_id', $orderDetail->service->id)->first()?->orderServiceTime?->price }}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <p class="mt-1 font-italic">
                                                                        {{ $order->orderServiceNotes->where('order_service_id', $orderDetail->service->id)->pluck('notes')->implode('<br>') }}
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    @endforeach
                                                    <br>
                                                    @if(file_exists('dashboard/img/order/' . $order->user->name . '/' . $order->slug . '.' . 'zip'))
                                                     <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group text-center">
