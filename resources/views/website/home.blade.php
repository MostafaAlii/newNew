            ...
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                 ...
                 <ol class="carousel-indicators">
                                @foreach($sliders as $key => $service)
                                    <li data-target="#carouselExampleControls" data-slide-to="{{ $key }}" class=class="@if($key == 0) active @endif"></li>
                                @endforeach
                            </ol>
    ...
    <div class="trowsection">
        <div class="container">
            <div class="text-center row" style="background-color: #e9e9e9">
                ...
                <div class="@if($key == 0 || $key == 2) col-lg-3 @endif @if($key == 1 || $key == 3 || $key == 4) col-lg-2 @endif col-md-6 col-sm-6 col-xs-6 wow fadeInUp" data-wow-delay="0.1s">
                            ...
                            <div class="carousel-inner">
                                ...
                                <div class="carousel-item @if($key == 0) active @endif hel">
                                    <h3 style="color: #e00000">
                                        {{ substr($comment->body, 0, 20) }} @if(strlen($comment->body) > 20) ... @endif
                                    </h3>
                                    <p>{{ $comment?->body }}</p>
...
<div id="carouselExampleControlss" class="carousel slide" data-ride="carousel">
    ...
    <ol class="carousel-indicators">
        @foreach($servicesWithGallery as $key => $service)
    ...
    <div class="carousel-inner">
        @forelse ($servicesWithGallery as $key => $slider)
        <div class="carousel-item @if($key == 0) active @endif">
            <img class="d-block w-100" src="{{ asset($slider->ImagePath()) }}" alt="{{ $slider?->name }}" />
        </div>
            ...
            <span class="sr-only">Next</span>
                    ...
                    <div class="fosectiontitle">
                      <h1 class="text-center">
                        ...
                        {{ $servicesWithGallery->last()->name }}
                      </h1>
                      <p>
                        {{ $servicesWithGallery->last()->notes }}
                      </p>
                      <div class="btnss">
                        @if($services_btn)
