            ...
            <div class="col-12 col-sm-8 col-md-9">
                ...
                <div class="dashboard-contents">
                    <div class="contents create-order-cont">
                        ...
                        <!-- Start Modal -->
                        @include('website.dashboard.modals.services_show_modal')
                        <!-- End Modal -->
                        <div>
                            <!-- Start Table -->
                            <table class="w-100 services-summary mt-3 table d-table">
                                ...
                                @foreach ($selectedServices as $service)
                                    ...
                                    <tr class="table-row" style="display: table-row" id="service-row-{{ $service->name }}">
                                        <td class="selectedService {{ $service->name }}_selected_service" class="text-left" width="20%"
                                        ...
                                        <!-- photos count -->
                                        <td class="{{ $service->name }}-photos-no" width="20%" data-service-name="{{ $service->name }}">
                                            0
                                        </td>
                            ...
                            <!-- End Table -->
                            <!-- Service Table -->
                            @includeWhen(!empty($selectedServices), 'website.dashboard.service_upload_table')
                            <!-- Service Table -->
                        </div>
                    </div>
                </div>
